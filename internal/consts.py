...
class DEBUG:
    ...
    IMPORTS = "Import messages"

FORCE_DEBUG_MODES_LIST = [DEBUG.ERROR, DEBUG.EVENT_DATA, DEBUG.EVENT_ACTIONS, DEBUG.WINDOW_CHANGES, DEBUG.WARNING_DEPRECIATED_FEATURE, DEBUG.NOTE_MODE, DEBUG.IMPORTS]
