...
CONSOLE_DEBUG_MODE = [internalconstants.DEBUG_WARNING_DEPRECIATED_FEATURE, internalconstants.DEBUG_EVENT_DATA, 
                      internalconstants.DEBUG_EVENT_ACTIONS, internalconstants.DEBUG_WINDOW_CHANGES]
